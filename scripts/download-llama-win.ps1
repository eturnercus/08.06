# Downloads llama.cpp Windows binaries for NeuroForge subprocess inference.
...
Write-Host "[INFO] Rebuild NeuroForge or run from project with embedded llama disabled."
